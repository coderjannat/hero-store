...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <i class="fas fa-star text-warning"></i>
      <i class="fas fa-star text-warning"></i>
      <i class="fas fa-star-half-alt text-warning"></i><span class = "text-muted fs-6 ps-1">${product.rating.rate}</span><br>
      <span class = "text-muted fs-6">${product.rating.count} Ratings </span>
...
const updateTotal = () => {
  ...
  document.getElementById("total").innerText = grandTotal.toFixed(2) * 0.15;
